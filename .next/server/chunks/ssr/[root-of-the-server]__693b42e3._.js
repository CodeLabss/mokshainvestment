module.exports = [
"[project]/mokshainvestment/.next-internal/server/app/services/loan/page/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/mokshainvestment/app/services/loan/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

// "use client";
// import React, { useState, ReactNode } from "react";
// import Navbar from "@/components/Navbar";
// import Footer from "@/components/Footer";
// import { Home, Car, FileText, Calculator, Shield, X, Phone, Mail, Clock, CheckCircle } from "lucide-react";
...
//                 <h4 className="font-semibold text-indigo-800 mb-3">Get Personalized Loan Options</h4>
//                 <p className="text-indigo-700 text-sm mb-4">
//                   Our loan specialists will find the perfect financing solution for your needs.
//                 </p>
...
//                     Request a Callback
//                   </button>
//                   <button className="w-full py-2 border border-indigo-300 text-indigo-600 rounded-lg font-medium hover:bg-indigo-50 transition-colors flex items-center justify-center">
...
//                     <p className="text-gray-600 text-sm">Get the best interest rates in the market</p>
//                   </div>
//                 </div>
//                 <div className="flex items-start">
//                   <div className="bg-indigo-100 p-2 rounded-lg mr-4">
...
//                     <p className="text-gray-600 text-sm">Fast processing and quick disbursal</p>
//                   </div>
//                 </div>
//                 <div className="flex items-start">
//                   <div className="bg-indigo-100 p-2 rounded-lg mr-4">
...
//                     <p className="text-gray-600 text-sm">Customizable repayment options</p>
//                   </div>
//                 </div>
//               </div>
//               {/* Loan Calculator CTA */}
...
//           </div>
//           {/* CTA Section */}
//           <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-center text-white shadow-md mb-12">
//             <Calculator className="w-12 h-12 mx-auto mb-4" />
//             <h2 className="text-2xl font-bold mb-3">Need Loan Assistance?</h2>
//             <p className="text-indigo-100 mb-6 max-w-2xl mx-auto">
//               Our loan specialists can help you find the perfect financing solution for your needs.
//             </p>
...
//                 <h4 className="font-semibold text-indigo-800 mb-4 text-lg">Get Personalized Loan Options</h4>
...
//                     Request a Callback
//                   </button>
//                   <button className="w-full py-3 border-2 border-indigo-300 text-indigo-600 rounded-lg font-semibold hover:bg-indigo-50 transition-colors flex items-center justify-center">
...
//     window.location.href = "mailto:jssucks7@gmail.com?subject=Loan Inquiry&body=Hello, I would like more information about your loan services.";
//   };
//   return (
//     <div className="fixed inset-0 bg-gray-800 bg-opacity-70 flex items-center justify-center z-50 p-4">
//       <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
...
"[project]/mokshainvestment/app/services/loan/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/mokshainvestment/app/services/loan/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__693b42e3._.js.map