...
function AdminDashboardPage() {
    ...
    async function fetchLeads() {
        try {
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from('leads').select('*').order('created_at', {
                ascending: false
            });
            if (error) {
    ...
    async function handleSignOut() {
        await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].auth.signOut();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b28e8bdd._.js.map