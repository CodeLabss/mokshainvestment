...
function DashboardPage() {
    const [stats, setStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        categories: 0,
        subcategories: 0,
        companies: 0,
        submissions: 0
    ...
    const fetchStats = async ()=>{
        setLoading(true);
        try {
            const { data: categories, error: catErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from("insurance_categories").select("*", {
                count: "exact"
            });
            const { data: subcategories, error: subErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from("insurance_subcategories").select("*", {
                count: "exact"
            });
            const { data: companies, error: compErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from("insurance_companies").select("*", {
                count: "exact"
            });
            const { data: submissions, error: submErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from("form_submissions").select("*", {
                count: "exact"
            });
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96f9d0fb._.js.map