module.exports = [
"[project]/mokshainvestment/.next-internal/server/app/api/admin/seed-categories/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/mokshainvestment/app/api/admin/seed-categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    try {
        ...
        const { data: existingCategories, error: checkError } = await supabase.from("insurance_categories").select("id");
        if (checkError) {
        ...
        const { data, error } = await supabase.from("insurance_categories").insert(initialCategories).select();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a0a513f._.js.map