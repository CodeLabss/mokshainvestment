...
const UpcomingNFOPage = ()=>{
    var _nfoData_activeIndex, _nfoData_activeIndex1;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UpcomingNFOPage.useEffect": ()=>{
            const fetchNFOData = {
                "UpcomingNFOPage.useEffect.fetchNFOData": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        ...
                        if (data) {
                            ...
                            const activeNFOs = data.filter({
                                "UpcomingNFOPage.useEffect.fetchNFOData.activeNFOs": (nfo)=>!nfo.end_date || nfo.end_date >= currentDate
                            }["UpcomingNFOPage.useEffect.fetchNFOData.activeNFOs"]);
            ...
            }["UpcomingNFOPage.useEffect.fetchNFOData"];
            fetchNFOData();
        }
    }["UpcomingNFOPage.useEffect"], []);
    ...
    const getImageUrl = (imagePath)=>{
        ...
        const { data } = supabase.storage.from('nfo-images').getPublicUrl(filename);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UpcomingNFOPage.useEffect": ()=>{
            ...
            const interval = setInterval({
                "UpcomingNFOPage.useEffect.interval": ()=>{
                    setActiveIndex({
                        "UpcomingNFOPage.useEffect.interval": (prev)=>(prev + 1) % nfoData.length
                    }["UpcomingNFOPage.useEffect.interval"]);
                }
            }["UpcomingNFOPage.useEffect.interval"], 5000);
            return ({
                "UpcomingNFOPage.useEffect": ()=>clearInterval(interval)
            })["UpcomingNFOPage.useEffect"];
        }
    }["UpcomingNFOPage.useEffect"], [
        nfoData
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UpcomingNFOPage.useEffect": ()=>{
            if (nfoData.length > 0) {
                ...
                const testUrl = getImageUrl((_nfoData_ = nfoData[0]) === null || _nfoData_ === void 0 ? void 0 : _nfoData_.image_url);
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        ...
                                                        " Showing ",
                                                        nfoData.length,
                                                        " NFO(s). Current image path: ",
                                                        (_nfoData_activeIndex = nfoData[activeIndex]) === null || _nfoData_activeIndex === void 0 ? void 0 : _nfoData_activeIndex.image_url
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/mokshainvestment/app/services/nfo/page.tsx",
                                                    lineNumber: 453,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        ...
                                                        " ",
                                                        getImageUrl((_nfoData_activeIndex1 = nfoData[activeIndex]) === null || _nfoData_activeIndex1 === void 0 ? void 0 : _nfoData_activeIndex1.image_url)
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/mokshainvestment/app/services/nfo/page.tsx",
                                                    lineNumber: 457,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "relative w-full h-[500px] rounded-2xl overflow-hidden border border-white/20 shadow-2xl",
                                            children: [
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold mb-4 ".concat(isCurrentlyOpen(nfoData[activeIndex]) ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-amber-500/20 text-amber-400 border border-amber-500/30'),
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"], {
                                                                        ...
                                                                        nfoData[activeIndex].description && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                nfoData.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-3",
                                                    children: nfoData.map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: ()=>setActiveIndex(index),
                                                            className: "w-3 h-3 rounded-full transition-all ".concat(index === activeIndex ? 'bg-amber-400 scale-125' : 'bg-white/50 hover:bg-white/70')
                                                        }, index, false, {
                                                            fileName: "[project]/mokshainvestment/app/services/nfo/page.tsx",
                                                            lineNumber: 547,
                                                            columnNumber: 25
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    className: "px-8 py-4 bg-white text-gray-900 font-semibold rounded-lg hover:bg-amber-100 transition-colors text-lg",
...
_s(UpcomingNFOPage, "SQ8JZ8PrAKmh7/96IAKwrLm2EVc=");
_c = UpcomingNFOPage;
const __TURBOPACK__default__export__ = UpcomingNFOPage;
var _c;
__turbopack_context__.k.register(_c, "UpcomingNFOPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=mokshainvestment_c01001a3._.js.map