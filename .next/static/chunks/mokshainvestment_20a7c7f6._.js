...
"[project]/mokshainvestment/app/admin/subcategories/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SubcategoriesAdmin = ()=>{
    ...
    const fetchSubcategories = async ()=>{
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from("insurance_subcategories").select("*, category:insurance_categories(id,name)").eq("is_active", true).order("created_at", {
            ascending: false
        });
        if (error) {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (editing && form.id) {
            // Update
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from("insurance_subcategories").update({
                name: form.name,
            ...
            // Create
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from("insurance_subcategories").insert({
                name: form.name,
                description: form.description,
                category_id: form.category_id,
                is_active: true
                        ...
                        children: subcategories.map((sub)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                        className: "border px-3 py-2",
                                        children: (_sub_category = sub.category) === null || _sub_category === void 0 ? void 0 : _sub_category.name
                                    }, void 0, false, {
                                        fileName: "[project]/mokshainvestment/app/admin/subcategories/page.tsx",
                                        lineNumber: 163,
                                        columnNumber: 17
...
_s(SubcategoriesAdmin, "6Re208YS4Xn3QI+OnhXzNoE7Yds=");
_c = SubcategoriesAdmin;
const __TURBOPACK__default__export__ = SubcategoriesAdmin;
var _c;
__turbopack_context__.k.register(_c, "SubcategoriesAdmin");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=mokshainvestment_20a7c7f6._.js.map