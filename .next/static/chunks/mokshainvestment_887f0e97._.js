...
var __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/mokshainvestment/lib/supabase/client.ts [app-client] (ecmascript)"); // Updated import
...
function AdminDashboardPage() {
    ...
    async function fetchLeads() {
        try {
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('leads').select('*').order('created_at', {
                ascending: false
            });
            if (error) {
    ...
    async function handleSignOut() {
        await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
...
//# sourceMappingURL=mokshainvestment_887f0e97._.js.map