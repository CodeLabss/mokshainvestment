...
function AdminLoginPage() {
    ...
    async function onSubmit(e) {
        ...
        setError(null);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mokshainvestment$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.signInWithPassword({
                email: email.trim(),
                password
            });
            if (error) {
...
//# sourceMappingURL=mokshainvestment_2057d7e8._.js.map