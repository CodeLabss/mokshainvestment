...
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";
import { ChartLine, TrendingUp, BarChart3, Shield, X, Phone, Mail, Clock, CheckCircle, ArrowRight, Building2, Users, Target, Star, Plus } from "lucide-react";
import Link from "next/link";
      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-6">
          <div className="space-y-6">
            {/* Description */}
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3">About This Investment</h3>
            ...
            <div className="bg-gradient-to-r from-amber-500 to-amber-400 rounded-2xl p-6 text-white">
              <h4 className="font-bold text-lg mb-2">Ready to Start Investing?</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
              <div className="text-center p-4 bg-gray-50 rounded-xl">
                ...
                <h5 className="font-semibold text-gray-800 text-sm">Expert Guidance</h5>
                <p className="text-gray-600 text-xs">Professional advice</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-xl">
                <Shield className="w-8 h-8 text-amber-500 mx-auto mb-2" />
                <h5 className="font-semibold text-gray-800 text-sm">Secure Platform</h5>
                <p className="text-gray-600 text-xs">Safe investments</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-xl">
                <Target className="w-8 h-8 text-amber-500 mx-auto mb-2" />
                <h5 className="font-semibold text-gray-800 text-sm">Goal-Based</h5>
                <p className="text-gray-600 text-xs">Customized plans</p>
              </div>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      subcategories: [
        { 
          ...
          name: "Liquid Funds", 
          description: "Short-term investments with high liquidity and stability. Ideal for parking surplus funds with minimal risk and easy withdrawal options.",
          icon: <ChartLine className="w-8 h-8 text-sky-400" />,
          features: [
  ...
  return (
    <main className="flex flex-col min-h-screen bg-transparent">
      ...
      <section className="flex-1 pt-32 pb-20 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          {/* Enhanced Header matching theme */}
          ...
          {/* Investment Categories matching theme */}
        ...
        {/* Main CTA Section matching theme - Updated with single bigger button */}
        <div className="max-w-7xl mx-auto px-6 mt-8">
          <div className="bg-gradient-to-r from-amber-500 to-amber-400 rounded-2xl p-10 text-center text-white shadow-xl">
            ...
            <p className="text-amber-100 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              Our investment experts will analyze your needs and recommend the best mutual funds 
              from our 12+ partner fund houses to ensure you get optimal returns.
            </p>
