  ...
  return (
    <div className="relative min-h-screen flex flex-col text-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Intro Section - Now perfectly centered vertically */}
        <section className="flex flex-col justify-center items-center text-center px-6 min-h-[80vh]">
        ...
        {/* Mini CTA - Now with amber gradient background */}
        <section className="py-20 text-center bg-gradient-to-r from-amber-500/20 via-amber-400/10 to-yellow-500/20 backdrop-blur-sm border-t border-amber-400/10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Begin Your Financial Journey?
          </h2>
